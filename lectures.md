...
**Material**: 
- Lecture Slides: [Large PDF]({{ site.baseurl }}/class-material/Lecture18_BGGN213-large.pdf){:.no-push-state}, [Small PDF]({{ site.baseurl }}/class-material/Lecture18_BGGN213-small.pdf){:.no-push-state}.  
